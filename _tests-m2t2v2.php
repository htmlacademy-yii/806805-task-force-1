...
$classData[] = [2, 'task2', AvailableActions::STATUS_RUNNING, '2019-12-11', 1, 2];
$classData[] = [3, 'task3', AvailableActions::STATUS_CANCELED, '2019-12-11', 1, 2];
$classData[] = [4, 'task4', AvailableActions::STATUS_NEW, '2019-12-11', 3, NULL];
